                                        ...
                                        <form class="form-horizontal">
                                            ...
                                            <div class="form-group row">
                                                <label for="employee_position" class="col-sm-2 col-form-label">Employee
                                                    Position</label>
                                                <div class="col-sm-10">
                                                    <?php $emp_positions = DB::table('emp_positions')
                                                        ->where('id', $datas->jabatan)
                                                        ->where('status_delete', '!=', 1)
                                                        ->pluck('name'); ?>
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($emp_positions[0]) ? $emp_positions[0] : '' }}"
                                                        style="background-color: #FFFFFF;" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <label for="role" class="col-sm-2 col-form-label">Length Of
                                                    Service</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control"
